...
# Install additional dependencies for WoanArm
...
TEXT3="cd /home/$USERNAME/woanarm_ws && source install/setup.bash"
TEXT4="ros2 launch woan_bringup x1_l_moveit_bringup.launch.py"
