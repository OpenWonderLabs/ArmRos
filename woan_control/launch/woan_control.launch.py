...
def generate_launch_description():
    ...
    declared_arguments = [
        DeclareLaunchArgument(
            "arm_type",
            default_value="a1_r",
            description="机械臂型号：x1_l、x1_r、a1_l、a1_r",
        ),
        DeclareLaunchArgument(
...
def launch_setup(context, *args, **kwargs):
    ...
    # 映射机械臂型号到配置
    arm_configs = {
        "x1_l": {"urdf_name": "x1_l_urdf", "package_name": "x1_l_config"},
        "x1_r": {"urdf_name": "x1_r_urdf", "package_name": "x1_r_config"},
    ...
    # 延迟启动 woan_control_node，等待 robot_state_publisher 初始化完成
