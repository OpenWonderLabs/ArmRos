...
```bash
# 使用speed_scale（推荐）
ros2 topic pub --once /onero_driver/movej_cmd onero_interfaces/msg/MoveJ "{
...
```bash
# 示例
ros2 topic pub --once /onero_driver/movel_cmd onero_interfaces/msg/MoveL "{
  pose: {
...
```bash
ros2 topic echo /onero_driver/arm_state
```
